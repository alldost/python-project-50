...
JSON_INPUT = [
    (JSON_FLAT1, JSON_FLAT2, 'json', JSON_FLAT_RESULT),
    (YAML_FLAT1, YAML_FLAT2, 'json', JSON_FLAT_RESULT),
    (JSON_NESTED1, JSON_NESTED2, 'json', JSON_NESTED_RESULT),
    (YAML_NESTED1, YAML_NESTED2, 'json', JSON_NESTED_RESULT)
]
